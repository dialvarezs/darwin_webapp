...
class DriverAdmin(admin.ModelAdmin):
	...
	make_unavailable.short_description = "Marcar choferes seleccionados como no disponibles"
...
class CompanyAdmin(admin.ModelAdmin):
	...
	def make_unavailable(self, request, queryset):
		queryset.update(is_available=False)
	make_unavailable.short_description = "Marcar empresas seleccionadas como no disponibles"
