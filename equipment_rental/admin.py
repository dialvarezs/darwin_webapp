...
from .models import Equipment, StockModification, IDType, Client, Lease, LeaseEquipments, Surcharge
...
class ClientAdmin(admin.ModelAdmin):
	form = MyClientForm
	list_display = ['id_string', 'id_type', 'nationality', 'names', 'surnames', 'date_of_birth']
...
class LeaseAdmin(admin.ModelAdmin):
	list_display = ['__str_equipments__', 'client', 'lease_record', 'return_date', 'total_cost', 'total_surcharge']
